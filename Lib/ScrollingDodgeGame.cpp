...
string  gameImage = dir + "GameOver.png", gameLogoImage = dir + "bert-game-logo.png";
string  cactusImage = dir + "Cactus.png";
string  groundImage = dir + "Ground.png";
string  bertNeutralImage = dir + "Bert-neutral.png", bertRunningImage = dir + "Bert.gif";
string  bertRun1 = dir + "Bert-run1-mia.png", bertRun2 = dir + "Bert-run2-mia.png";
string  bertDeterminedImage = dir + "Bert-determined.png", bertDeadImage = dir + "Bert-dead.png";
string  clockImage = dir + "Clock.png";
string  heartImage = dir + "Heart.png";
string  sunImage = dir + "Sun.png";
string	cloudsImage = dir + "Clouds.png";

// animations
vector<string> bertNames = { bertRun1, bertRun2 };
vector<string> bertIdles = { dir + "Bert-idle_0.png", dir + "Bert-idle_1.png",dir + "Bert-idle_2.png", dir + "Bert-idle_3.png", dir + "Bert-idle_4.png" };
